    ...
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Login(User user)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var response = await httpClient.PostAsync("http://20.75.128.166/api/auth/User", content);
                ...
                using (var response1 = await httpClient.PostAsync("http://20.75.128.166/api/auth/Login", content1))
                {
