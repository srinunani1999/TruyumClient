        ...
        public async Task<ActionResult> IndexAsync()
        {
            ...
            using (var client = new HttpClient())
            {
               ...
               // http ://20.62.212.37/swagger/index.html
                using (var response = await client.GetAsync("http://20.62.212.37/api/menuitem"))
                {
        ...
        public async Task<ActionResult> CreateAsync(MenuItem menuItem)
        {
            try
            {
                ...
                using (var httpclinet = new HttpClient())
                {
                    ...
                    using (var response = await httpclinet.PostAsync("http://20.62.212.37/api/MenuItem", content))
                    {
